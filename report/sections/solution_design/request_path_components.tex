...
sequence of components that a single user message traverses between arrival at the orchestrator and the
...
element of the scene chosen to fit the semantics of the
