...
The components described so far are all invisible to the
...
\texttt{/portal/campaigns/\{campaign\_id\}/ads}. Its so that ownership is
...
advertiser sees is computed by a SQL
