...
the two human workstreams, state the limitations of the current
...
The project was delivered by two human workstreams that developed in
...
\begin{itemize}[leftmargin=1.8em]
  ...
  \item \textbf{Domain-specific context extraction.} Fine-tune the
    ...
    Haiku-tier call can be replaced with a smaller, cheaper, and
